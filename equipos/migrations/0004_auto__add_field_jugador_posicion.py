...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'equipos_jugador', 'posicion',
                      self.gf('django.db.models.fields.CharField')(default='seleccione_posicion', max_length=10),
                      keep_default=False)
    ...
    models = {
        ...
        u'equipos.jugador': {
            ...
            'posicion': ('django.db.models.fields.CharField', [], {'default': "'seleccione_posicion'", 'max_length': '10'})
        }
    }
